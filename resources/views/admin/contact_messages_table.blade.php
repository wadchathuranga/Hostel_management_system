                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">All: {{$msg_count}}</div>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-warning border-bottom-warning shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Total New Messages</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">New: {{$msg_new}}</div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-university fa-2x text-gray-300"></i>
                            </div>
                    ...
                    <table class="table table-dark" id="dataTable" width="100%" cellspacing="0">
                        ...
                        @foreach($all_msg as $msg)
                            <tr>
                                ...
                                <td><center>
                                    @if($msg->isRead==0)
                                        <a href="/admin/message_read/{{$msg->id}}" class="badge badge-warning text-lg">New</a>
                                    @else
                                        <a class="badge badge-success">Read</a>
                                    @endif
                                    </center></td>
                                <td><center>
